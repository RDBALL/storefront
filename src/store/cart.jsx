  ...
  switch(action.type) {
    case 'add_product':
      state = {
        ...
        productList: updateCartProducts(state.productList, action.payload.product, true),
      }
      return state;
    case 'remove_product':
      state = {
        numberOfItems: state.numberOfItems - 1,
        productList: updateCartProducts(state.productList, action.payload.product, false),
      }
      return state;
